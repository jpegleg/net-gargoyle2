    ...
    stages {
        ...
        stage('Publish') {
            steps {
                ...
                sh "cd /srv/debbuild/ && rm -rf kill-ngr __pycache__/ packages/ net-gargoyle2/ && tar czvf net-gargoyle2-1.0.0.tar.gz net-gargoyle2-1.0.0/ && dpkg -b ./net-gargoyle2-1.0.0 ./net-gargoyle2-1.0.0.deb"
            }
            post {
                success {
